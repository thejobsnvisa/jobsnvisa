    ...
    <section className="w-full min-h-auto lg:min-h-[720px] bg-green-50 rounded-tl-[30px] lg:rounded-tl-[100px] rounded-tr-[30px] lg:rounded-tr-[100px] py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-8 mt-12 lg:mt-16">
          {/* Card 1 */}
          <div
            className="relative w-full max-w-[540px] h-[450px] rounded-tl-[30px] rounded-bl-[30px]  rounded-tr-[30px] lg:rounded-tl-[80px] lg:rounded-tr-[80px] overflow-hidden"
            style={{
          ...
          >
            <div className="absolute inset-0 flex flex-col items-center justify-center  px-6 text-center">
              ...
              <p className="w-full max-w-[430px] text-[16px] lg:text-[18px] leading-8 text-green-900 mt-2">
              ...
              <div className="flex flex-col items-center mt-6">
                <ul className="w-full max-w-[295px] text-left font-semibold text-[14px] lg:text-[16px] text-green-800 space-y-2 mb-8">
          ...
          >
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white px-6 text-center">
              ...
              <div className="flex flex-col items-center mt-6">
                <ul className="w-full max-w-[447px] text-left font-semibold text-[14px] lg:text-[16px] text-green-800 space-y-2 mb-8">
