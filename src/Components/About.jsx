  ...
  return (
    ...
    <section className="w-full max-w-[1440px] mx-auto py-12 md:py-20 px-6 lg:px-20 bg-white">
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-8 lg:gap-10">
        ...
        <div className="relative w-full lg:w-[650px]  lg:h-[440px] mt-6 rounded-tl-[100px] rounded-tr-[100px] bg-green-100 p-10 flex items-center justify-center">
          <div className="w-[540px] h-[354px] mt-20 rounded-tl-[80px] rounded-tr-[80px] overflow-hidden shadow-[0_20px_40px_rgba(16,185,129,0.15)]">
            <img
        ...
        <div className="w-full lg:w-[780px] lg:min-h-[500px] rounded-tl-[30px] rounded-tr-[30px] lg:rounded-tl-[80px] lg:rounded-tr-[80px] bg-white p-6 md:p-10 flex flex-col justify-center">
          <p
            className="text-[16px] leading-[30px] text-green-950 font-medium text-justify mb-8"
