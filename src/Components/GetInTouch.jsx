      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[470px] px-4 py-10 sm:px-6 sm:py-14">
          ...
          <div className="w-full max-w-[1138px] grid gap-6 md:grid-cols-3">
            <div className="bg-white/80 backdrop-blur-md rounded-[30px] relative w-full min-h-[60px] lg:min-h-[220px] p-8 shadow-xl text-center">
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-[30px] relative w-full min-h-[100px] lg:min-h-[220px] p-8 shadow-xl text-center">
              <div className="absolute -top-6 md:left-[10px] lg:left-[20px] -translate-x-1/2 h-[51px] w-[51px] bg-green-200 rounded-[18px] rounded-bl-[18px] p-[8px] flex items-center justify-center">
